        ...
        <div className="max-w-lg mx-auto my-10 p-8 md:w-2/5 w-full">
            ...
            <form action="" className="my-10">
                <div className="flex flex-col space-y-5">
                    ...
                    <button className="w-full py-[10px] font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg border-indigo-500 hover:shadow inline-flex space-x-2 items-center justify-center" onClick={(e)=>{handleSubmitEmail(email)}}>
